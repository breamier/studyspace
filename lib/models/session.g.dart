...
Session _sessionDeserialize(
  ...
  object.id = id;
  object.imgPath = reader.readString(offsets[2]);
...
extension SessionQueryLinks
    on QueryBuilder<Session, Session, QFilterCondition> {
  QueryBuilder<Session, Session, QAfterFilterCondition> goal(
      FilterQuery<Goal> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Session, Session, QAfterFilterCondition> goalIsNull() {
    return QueryBuilder.apply(this, (query) {
